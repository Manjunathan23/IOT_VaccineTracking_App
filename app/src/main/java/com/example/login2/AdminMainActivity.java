...
public class AdminMainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        final ImageView adBtn=findViewById(R.id.adminBtn);
        ...
        adBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AdminMainActivity.this,AdminPage.class));
                finish();
            }
        });
        ...
        goBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(tripTxt.isEmpty()){
                    Toast.makeText(AdminMainActivity.this,"Enter Trip Id to continue",Toast.LENGTH_SHORT).show();
                }else{
                    databaseReference.child("vaccination").child(tripTxt).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists()){
                                ...
                                geocoder = new Geocoder(AdminMainActivity.this, Locale.getDefault());
                                ...
                                Toast.makeText(AdminMainActivity.this,"Trip id not found",Toast.LENGTH_SHORT).show();
                            }
                        }
